...
func resourceLinuxVirtualMachineDelete(d *schema.ResourceData, meta interface{}) error {
	...
	// TODO
	// Error: Error Deallocating to Linux Virtual Machine "tom-devvm" (Resource Group "tom-dev"): compute.VirtualMachinesClient#Deallocate: Failure sending request: StatusCode=0 -- Original Error: autorest/azure: Service returned an error. Status=<nil> Code="OperationNotAllowed" Message="Operation 'deallocate' is not supported for VMs or VM Scale Set instances using an ephemeral OS disk."
